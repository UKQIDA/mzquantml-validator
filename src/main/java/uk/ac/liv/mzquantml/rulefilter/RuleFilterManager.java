 ...
 */
package uk.ac.liv.mzquantml.rulefilter;
...
import uk.ac.liv.mzquantml.rulefilter.jaxb.*;

/**
 *
 * @author Da Qi
 * @institute University of Liverpool
 * @time 20-Sep-2012 11:20:49
 */
public class RuleFilterManager {
    ...
    public RuleFilterManager(InputStream xmlFile) throws JAXBException {
        ...
        jc = JAXBContext.newInstance("psidev.psi.pi.rulefilter.jaxb");
    ...
    public List<String> getMandatoryElements() {
        ...
        if (filter.getMandatoryElements() != null) {
            for (MandatoryMzQuantMLElement mandatoryElement : filter.getMandatoryElements().getMandatoryMzQuantMLElement()) {
                final String mzQuantMLElement = mandatoryElement.getMzQuantMLElement();
                if (mzQuantMLElement != null && !"".equals(mzQuantMLElement)) {
                    ret.add(mzQuantMLElement);
                }
            }
...
* : the key is the identifier of the condition and the value is
     ...
     */
    public Set<String> getCVMappingRulesToSkipByUserOptions(
    ...
    private List<CvMappingRuleToSkip> getMappingRulesToSkip(
                    ...
                    if (option.getRulesToSkipRef() != null) {
                        for (RulesToSkipRef rulesToSkipRef : option.getRulesToSkipRef()) {
                            if (filter.getReferences() != null
                                ...
                                for (ReferencedRules referencedRuleSet : filter.getReferences().getReferencedRules()) {
                                    if (referencedRuleSet.getId().equals(rulesToSkipRef.getRef())) {
                                        if (referencedRuleSet.getCvMappingRuleToSkip() != null) {
                                            cvMappingRulesToSkip.addAll(referencedRuleSet.getCvMappingRuleToSkip());
                                        }
                                    }
                                }
                            }
...
* : the key is the identifier of the condition and the value is
     ...
     * @return the list of identifiers of rules to exclude
     */
    public Set<String> getObjectRulesToSkipByUserOptions(
            HashMap<String, String> selectedOptions) {
    ...
    private List<ObjectRuleToSkip> getObjectRulesToSkip(UserCondition condition,
                                                        String optionId) {
    ...
    private List<String> getObjectRulesToSkipByObjectRule(String ruleId,
                                                          boolean valid) {
        List<String> ret = new ArrayList<String>();

        if (this.filter.getObjectRuleConditions() != null) {
            for (ObjectRuleCondition objectRuleCondition : this.filter.getObjectRuleConditions().getObjectRuleCondition()) {
    ...
    private List<String> getCvMappingRulesToSkipByObjectRule(String ruleId,
                                                             boolean valid) {
        List<String> ret = new ArrayList<String>();
                ...
                if (objectRuleCondition.getId().equals(ruleId)) {
                    if ((valid && objectRuleCondition.isValid())
                        ...
                        if (objectRuleCondition.getCvMappingRuleToSkip() != null) {
                            for (CvMappingRuleToSkip cvMappingRule : objectRuleCondition.getCvMappingRuleToSkip()) {
    ...
    public List<String> getCvMappingRulesToSkipByCvMappingRule(String ruleId,
                                                               boolean valid) {
        List<String> ret = new ArrayList<String>();

        if (this.filter.getCvMappingRuleConditions() != null) {
            for (CvMappingRuleCondition cvMappingRule : this.filter.getCvMappingRuleConditions().getCvMappingRuleCondition()) {
                if (cvMappingRule.getId().equals(ruleId)) {
                    if ((valid && cvMappingRule.isValid()) || (!valid && !cvMappingRule.isValid())) {
                        if (cvMappingRule.getCvMappingRuleToSkip() != null) {
                            for (CvMappingRuleToSkip cvMappingRule2 : cvMappingRule.getCvMappingRuleToSkip()) {
    ...
    public List<String> getObjectRulesToSkipByCvMappingRule(String ruleId,
                                                            boolean valid) {
        List<String> ret = new ArrayList<String>();
     ...
     */
    public void addCvMappingRulesToSkip(
            Collection<String> cvMappingRulesIdentifiers) {
...
* if the rule has been passed or not
     */
    public void updateRulesToSkipByCvMappingRuleResult(CvRule rule,
                                                       boolean valid) {
        // get cvMappingRules that should be skipped
        final List<String> cvMappingRulesToSkipByCvMappingRule = this.getCvMappingRulesToSkipByCvMappingRule(rule.getId(), valid);
        ...
        final List<String> objectRulesToSkipByCvMappingRule = this.getObjectRulesToSkipByCvMappingRule(rule.getId(), valid);
...
* if the rule has been passed or not
     */
    public void updateRulesToSkipByObjectRuleResult(ObjectRule rule,
                                                    boolean valid) {
        // get objectRules that should be skipped
...
* a set of pairs key, value, where the key is the identifier of
    ...
    public Collection<ValidatorMessage> filterValidatorMessages(
            HashMap<String, List<ValidatorMessage>> msgs,
            ExtendedValidatorReport extendedReport) {
    ...
    public void printRuleFilter() {
                        ...
                        if (filter.getReferences() != null) {
                            for (ReferencedRules referencedRuleSet : filter.getReferences().getReferencedRules()) {
                                if (referencedRuleSet.getId().equals(ruleSetReference.getRef())) {
                                    for (CvMappingRuleToSkip cvMappingRule : referencedRuleSet.getCvMappingRuleToSkip()) {
                                        System.out.println("\t\tmapping rule id: "
                                                + cvMappingRule.getId());
                                    }
                                    for (ObjectRuleToSkip objectRule : referencedRuleSet.getObjectRuleToSkip()) {
        ...
        if (filter.getObjectRuleConditions() != null) {
            ...
            for (ObjectRuleCondition objectRuleCondition : filter.getObjectRuleConditions().getObjectRuleCondition()) {
        ...
        if (filter.getCvMappingRuleConditions() != null) {
            ...
            for (CvMappingRuleCondition cvMappingCondition : filter.getCvMappingRuleConditions().getCvMappingRuleCondition()) {
                ...
                for (CvMappingRuleToSkip cvMappingRule : cvMappingCondition.getCvMappingRuleToSkip()) {
                    System.out.println("\t\tcvMapping rule to skip: " + cvMappingRule.getId());
                }
            }
        }
        if (filter.getMandatoryElements() != null) {
            ...
            for (MandatoryMzQuantMLElement mandatorymzQuantMLElement : filter.getMandatoryElements().getMandatoryMzQuantMLElement()) {
                System.out.println("\tMandatory mzQuantML element: "
                        + mandatorymzQuantMLElement.getMzQuantMLElement());
            }
        }
    }
}
